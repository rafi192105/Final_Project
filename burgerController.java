...
public class burgerController implements Initializable {
    ...
    @FXML
    private TableView<foodList> burgerTable;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        burgerTable.getSelectionModel().setSelectionMode(SelectionMode.SINGLE);
        this.list.clear();
        try{
            File file = new File("burgerItems.txt");
        ...
        burgerTable.setItems(this.list);
    ...
    public void deleteFood()throws IOException{
        foodList selectedItems = burgerTable.getSelectionModel().getSelectedItem();
