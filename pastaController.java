...
public class pastaController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<foodList> pastaTable;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        pastaTable.getSelectionModel().setSelectionMode(SelectionMode.SINGLE);
        this.list.clear();
        try{
            File file = new File("pastaItems.txt");
    ...
    public void deleteFood()throws IOException{
        foodList selectedItems = pastaTable.getSelectionModel().getSelectedItem();
