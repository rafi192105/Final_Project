...
public class pizzaController implements Initializable {
    ...
    @FXML
    private TableView<foodList> pizzaTable;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        pizzaTable.getSelectionModel().setSelectionMode(SelectionMode.SINGLE);
        this.list.clear();
        try{
            File file = new File("pizzaItems.txt");
    ...
    public void deleteFood()throws IOException{
        foodList selectedItems = pizzaTable.getSelectionModel().getSelectedItem();
